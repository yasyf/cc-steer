...
corrective oversampling). :mod:`~cc_steer.retrain.tinker` trains a LoRA on Thinking
Machines' managed Tinker API under a hard spend cap and scores checkpoints.
